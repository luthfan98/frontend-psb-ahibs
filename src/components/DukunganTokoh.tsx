  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div
          className="absolute bottom-20 left-20 w-96 h-96 bg-gradient-to-tr from-blue-200/20 to-cyan-200/15 rounded-full blur-3xl animate-pulse"
          style={{ animationDelay: '2s' }}
        />

        {/* Floating Icons */}
        <div
          className="absolute top-1/4 left-1/6 animate-bounce"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16">
          {dukungan.map((item, index) => (
            ...
            >
                    ...
                    >
                      {item.pattern === 'geometric' && (
                        <>
                          ...
                          <path
                            d="M40 15 L55 30 L40 45 L25 30 Z"
                            fill="none"
                            stroke="#0f766e"
                            strokeWidth="0.6"
                          />
                      ...
                      {item.pattern === 'floral' && (
                        <>
                          <path
                            d="M40 20 C50 30, 50 50, 40 60 C30 50, 30 30, 40 20"
                            fill="none"
                            stroke="#0f766e"
                            strokeWidth="0.7"
                          />
                          <path
                            d="M20 40 C30 30, 50 30, 60 40 C50 50, 30 50, 20 40"
                            fill="none"
                            stroke="#0f766e"
                            strokeWidth="0.7"
                          />
                      ...
                      {item.pattern === 'arabesque' && (
                        <>
                          <path
                            d="M40 10 Q60 30 40 50 Q20 30 40 10"
                            fill="none"
                            stroke="#0f766e"
                            strokeWidth="0.8"
                          />
                          <path
                            d="M10 40 Q30 20 50 40 Q30 60 10 40"
                            fill="none"
                            stroke="#0f766e"
                            strokeWidth="0.8"
                          />
              ...
              {/* Background Gradient */}
              <div
                className={`absolute inset-0 rounded-3xl bg-gradient-to-br ${item.color} opacity-0 group-hover:opacity-8 transition-opacity duration-500`}
              />
              ...
              <div className="relative z-10">
                ...
                <div className="mb-6">
                  <div
                    className={`inline-flex items-center gap-2 px-4 py-2 rounded-full text-xs font-bold bg-gradient-to-r ${item.color} text-white shadow-lg mb-3`}
                  >
                ...
                <div className="flex items-start gap-4">
                  <div className="relative flex-shrink-0">
                    <div
                      className={`absolute inset-0 rounded-full bg-gradient-to-r ${item.color} blur-lg opacity-30 group-hover:opacity-60 transition-opacity duration-300`}
                    />
                    <Image
                      src={item.avatar}
                      alt={item.name}
                    ...
                    <div
                      className={`absolute -bottom-1 -right-1 w-6 h-6 rounded-full bg-gradient-to-r ${item.color} flex items-center justify-center shadow-lg`}
                    >
